...
def setup_training(main_net, meta_net, exp_id=None):
    ...
    if args.optimizer == 'sam':
        main_opt = SAM(main_params, torch.optim.SGD, rho = 0.05, adaptive= 'True', lr=args.main_lr, momentum=args.momentum, weight_decay=args.wdecay)
    ...
    if args.dataset in ['cifar10', 'cifar100']:
        ...
        main_schdlr = torch.optim.lr_scheduler.MultiStepLR(main_opt, milestones=[40,50], gamma=0.1)
